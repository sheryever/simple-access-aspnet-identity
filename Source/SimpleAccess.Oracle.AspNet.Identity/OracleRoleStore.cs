...
using SimpleAccess.Oracle.AspNet.Identity.Repositories;
using System;
...
{
    public class OracleRoleStore<TRole> : IQueryableRoleStore<TRole>
        where TRole : IdentityRole
    {
        private readonly string _connectionString;
        private readonly RoleRepository<TRole> _roleRepository;
        public OracleRoleStore()
            : this("DefaultConnection")
        {

        }

        public OracleRoleStore(string connectionStringName)
        {
