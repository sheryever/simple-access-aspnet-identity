    ...
    public class UserRepository<TUser> where TUser : IdentityUser
    {
        ...
        public void Insert(TUser user)
        {
            using (var conn = new SqlConnection(_connectionString))
            {
                ...
                SqlHelper.ExecuteNonQuery(conn, @"INSERT INTO aspnetusers VALUES(@Id,@Email,@EmailConfirmed,@PasswordHash,@SecurityStamp,@PhoneNumber,@PhoneNumberConfirmed,
        ...
        public void Delete(TUser user)
        {
            using (var conn = new SqlConnection(_connectionString))
            {
                ...
                SqlHelper.ExecuteNonQuery(conn, @"DELETE FROM aspnetusers WHERE Id=@Id", parameters);
            }
        }
        ...
        public void Update(TUser user)
        {
            using (var conn = new SqlConnection(_connectionString))
            {
                ...
                SqlHelper.ExecuteNonQuery(conn, @"UPDATE aspnetusers 
